...
@Test func sampleAtStart() async throws {
    var timeSeries = TimeSeries<Int,Int>(from: 0.date, for: 10.seconds, every: 1.seconds, using: SampleSeries<Int>(), summarizer: MeasureValue<Int>())
...
@Test func sampleAtEnd() async throws {
    var timeSeries = TimeSeries<Int,Int>(from: 0.date, for: 10.seconds, every: 1.seconds, using: SampleSeries<Int>(), summarizer: MeasureValue<Int>(at:.end))
...
@Test func sampleInMiddle() async throws {
    var timeSeries = TimeSeries<Double,Double>(from: 0.date, for: 10.seconds, every: 1.seconds, using: SampleSeries<Double>(), summarizer: MeasureValue<Double>(at:.middle))
...
@Test func countSamples() async throws {
    var timeSeries = TimeSeries<Double,Int>(from: 0.date, for: 10.seconds, every: 1.seconds, using: SampleSeries<Double>(), summarizer: Count<Double>())
...
@Test func averagesFloatingPointValues() async throws{
    var timeSeries = TimeSeries<Double,Double>(from: 0.date, for: 10.seconds, every: 1.seconds, using: SampleSeries<Double>(), summarizer: AverageFloatingPointValue<Double>())
...
@Test func averagesIntegerValues() async throws{
    var timeSeries = TimeSeries<Int,Int>(from: 0.date, for: 10.seconds, every: 1.seconds, using: SampleSeries<Int>(), summarizer: AverageIntegerValue<Int>())
...
@Test func minMaxSum() async throws {
    var timeSeries = TimeSeries<Int,Int>(from: 0.date, for: 10.seconds, every: 1.seconds, using: SampleSeries<Int>(), summarizer: MaximumValue<Int>())
